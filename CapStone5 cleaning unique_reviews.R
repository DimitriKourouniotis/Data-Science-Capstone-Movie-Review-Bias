...
unique_reviews$review_text_summary_1 <- sapply(strsplit(unique_reviews$review_text_summary_1, split='&dash; ',fixed=TRUE), function(x) (x[1]))
...
clean_tMeterScore_ds$movie_title_allyears <- sapply(strsplit(movie_title_2000, split=' (1',fixed=TRUE), function(x) (x[1]))
